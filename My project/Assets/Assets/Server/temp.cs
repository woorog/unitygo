...
public class temp : MonoBehaviour
{
    ...
    //        for (int i = 0; i < 14; i++)
    //        {
    //            GameObject card = Instantiate(myCards[Random.Range(0, myCards.Count)], new Vector2(0, 0), Quaternion.identity);
...
//            card.GetComponent<Button>().onClick.RemoveAllListeners(); // 상대 카드 클릭 비활성화
//        }
//    }
//}
