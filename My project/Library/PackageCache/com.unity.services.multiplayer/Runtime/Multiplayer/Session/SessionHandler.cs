...
namespace Unity.Services.Multiplayer
{
    ...
    public interface ISession
    {
        ...
        /// </summary>
        /// <remarks>
        /// The <see cref="string"/> parameter represents the ID of the player who joined.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// The <see cref="string"/> parameter represents the ID of the player who left.
        /// </remarks>
    ...
    class SessionHandler : IServerSession
    {
            ...
            IPlayerId playerId)
        {
            ...
            LobbyHandler.PlayerLeft += OnPlayerLeft;
        ...
        {
            Logger.LogVerbose($"Session.OnPlayerLeft");
