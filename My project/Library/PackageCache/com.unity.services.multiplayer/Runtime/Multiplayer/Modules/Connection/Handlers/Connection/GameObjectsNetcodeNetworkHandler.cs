...
namespace Unity.Services.Multiplayer
{
    internal class GameObjectsNetcodeNetworkHandler : INetworkHandler
    {
        ...
        void SetupDistributedAuthority(NetworkConfiguration configuration)
        {
            ...
            {
                Logger.LogWarning("Enabling use CMB service in order to use Distributed Authority. This will be the default behavior in the future.");
            ...
            {
                Logger.LogWarning($"Setting {nameof(NetworkConfig.NetworkTopology)} to Distributed Authority. This will be the default behavior in the future.");
                NetworkManager.NetworkConfig.NetworkTopology = NetworkTopologyTypes.DistributedAuthority;
            }

            if (!NetworkManager.NetworkConfig.AutoSpawnPlayerPrefabClientSide)
            {
                Logger.LogWarning("Enabling auto spawn player prefab client side. This will be the default behavior in the future.");
