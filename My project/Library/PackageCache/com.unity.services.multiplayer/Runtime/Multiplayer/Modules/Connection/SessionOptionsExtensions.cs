namespace Unity.Services.Multiplayer
{
    ...
    public static partial class SessionOptionsExtensions
    {
        ...
        /// </summary>
        /// <remarks>
        /// The region is optional; the default behavior is to perform quality of service (QoS) measurements and pick
        /// the lowest latency region. The list of regions can be obtained from the Relay Allocations Service via <see
