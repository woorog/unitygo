...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class MultiplayConflictError
    {
        ...
        /// <param name="conflicts">A list of conflicts blocking an operation.</param>
        [Preserve]
        public MultiplayConflictError(string title, int status, List<ConflictItem> conflicts)
        {
            Title = title;
            Status = status;
            Conflicts = conflicts;
        ...
        public List<ConflictItem> Conflicts{ get; }
        ...
        internal string SerializeAsPathParam()
        {
            ...
            if (Conflicts != null)
            {
                serializedModel += "conflicts," + Conflicts.ToString();
            }
