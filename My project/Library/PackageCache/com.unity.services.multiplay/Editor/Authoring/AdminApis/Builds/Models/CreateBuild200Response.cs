...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class CreateBuild200Response
    {
        ...
        [Preserve]
        public CreateBuild200Response(string buildName, long buildID, BuildTypeOptions buildType, int cfv, SyncStatusOptions syncStatus, DateTime updated, CCDDetails ccd = default, ContainerImage container = default, AmazonS3Details s3 = default, OsFamilyOptions osFamily = default)
        {
            BuildName = buildName;
            BuildID = buildID;
            BuildType = buildType;
