...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class BuildListInner
    {
        ...
        [Preserve]
        public BuildListInner(string buildName, long buildID, BuildTypeOptions buildType, long buildConfigurations, SyncStatusOptions syncStatus, DateTime updated, CCDDetails ccd = default, ContainerImage container = default, AmazonS3Details s3 = default, OsFamilyOptions osFamily = default)
        {
            BuildName = buildName;
            BuildID = buildID;
            BuildType = buildType;
