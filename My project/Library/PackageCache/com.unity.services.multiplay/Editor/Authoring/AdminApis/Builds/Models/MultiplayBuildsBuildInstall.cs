...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class MultiplayBuildsBuildInstall
    {
        ...
        [Preserve]
        public MultiplayBuildsBuildInstall(string fleetName, long completedMachines, long pendingMachines, List<BuildListInner1FailuresInner> failures, List<RegionsInner> regions, System.Guid ccdBucketID = default, CCDDetails ccd = default, ContainerImage container = default)
        {
