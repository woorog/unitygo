...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class MultiplayBuildsBuildVersionUpdateReq
    {
        ...
        [Preserve]
        public MultiplayBuildsBuildVersionUpdateReq(CCDDetails2 ccd = default, ContainerImage container = default, AmazonS3Request s3 = default, bool forceRollout = false)
        {
            Ccd = ccd;
            Container = container;
            S3 = s3;
