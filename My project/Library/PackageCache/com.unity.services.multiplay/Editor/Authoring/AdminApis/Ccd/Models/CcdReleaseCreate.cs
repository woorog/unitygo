...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models
{
    ...
    internal class CcdReleaseCreate
    {
        ...
        [Preserve]
        public CcdReleaseCreate(List<ApiCcdManagementV1ProjectsProjectidBucketsBucketidReleasesEntries> entries = default, object metadata = default, string notes = default, DateTime snapshot = default)
        {
            Entries = entries;
