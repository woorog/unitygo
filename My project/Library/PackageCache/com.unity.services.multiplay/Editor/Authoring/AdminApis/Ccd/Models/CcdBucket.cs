...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models
{
    ...
    internal class CcdBucket
    {
        ...
        [Preserve]
        public CcdBucket(InlineResponse200Attributes attributes = default, InlineResponse200Changes changes = default, DateTime created = default, string description = default, System.Guid environmentId = default, string environmentName = default, System.Guid id = default, InlineResponse200LastRelease lastRelease = default, string name = default, InlineResponse200Permissions permissions = default, bool @private = default, System.Guid projectguid = default)
        {
