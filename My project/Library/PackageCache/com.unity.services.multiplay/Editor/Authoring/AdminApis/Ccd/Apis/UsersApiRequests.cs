...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Users
{
    ...
    internal class RegenerateUserApiKeyRequest : UsersApiBaseRequest
    {
        ...
        [Preserve]
        public string Userid { get; }
        /// <summary>Accessor for inlineObject33 </summary>
        [Preserve]
        public Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.InlineObject33 InlineObject33 { get; }
        string PathAndQueryParams;
        ...
        /// </summary>
        /// <param name="userid">User ID</param>
        /// <param name="inlineObject33">InlineObject33 param</param>
        [Preserve]
        public RegenerateUserApiKeyRequest(string userid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.InlineObject33 inlineObject33)
        {
            Userid = userid;
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(InlineObject33);
        }
