...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Orgs
{
    ...
    internal class SaveTosAcceptedRequest : OrgsApiBaseRequest
    {
        ...
        [Preserve]
        public string Orgid { get; }
        /// <summary>Accessor for inlineObject30 </summary>
        [Preserve]
        public Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.InlineObject30 InlineObject30 { get; }
        string PathAndQueryParams;
        ...
        /// </summary>
        /// <param name="orgid">Organization ID</param>
        /// <param name="inlineObject30">InlineObject30 param</param>
        [Preserve]
        public SaveTosAcceptedRequest(string orgid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.InlineObject30 inlineObject30)
        {
            Orgid = orgid;
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(InlineObject30);
        }
