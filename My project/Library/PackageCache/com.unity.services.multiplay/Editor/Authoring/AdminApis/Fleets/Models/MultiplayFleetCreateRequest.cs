...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class MultiplayFleetCreateRequest
    {
        ...
        [Preserve]
        public MultiplayFleetCreateRequest(string name, List<long> buildConfigurations, List<Region> regions, System.Guid osID = default, OsFamilyOptions osFamily = default)
        {
            Name = name;
            OsID = osID;
            OsFamily = osFamily;
