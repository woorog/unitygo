...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class MultiplayFleet
    {
        ...
        [Preserve]
        public MultiplayFleet(System.Guid id, string name, System.Guid osID, string osName, OsFamilyOptions osFamily, List<BuildConfiguration1> buildConfigurations, List<FleetRegion1> fleetRegions, StatusOptions status, long deleteTTL = default, long shutdownTTL = default, long disabledDeleteTTL = default)
        {
            Id = id;
            Name = name;
            OsID = osID;
