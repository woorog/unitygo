...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class FleetUpdateRequest
    {
        ...
        [Preserve]
        public FleetUpdateRequest(string name, System.Guid osID, List<long> buildConfigurations, long deleteTTL = default, long shutdownTTL = default, long disabledDeleteTTL = default)
        {
            Name = name;
            OsID = osID;
