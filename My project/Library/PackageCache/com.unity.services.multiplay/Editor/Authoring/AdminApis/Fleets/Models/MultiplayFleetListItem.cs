...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class MultiplayFleetListItem
    {
        ...
        [Preserve]
        public MultiplayFleetListItem(System.Guid id, string name, System.Guid osID, string osName, List<BuildConfiguration> buildConfigurations, List<FleetRegion> regions, StatusOptions status)
        {
            Id = id;
            Name = name;
            OsID = osID;
