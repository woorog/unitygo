...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    internal class BuildConfiguration
    {
        ...
        [Preserve]
        public BuildConfiguration(long id, string name, long buildID, string buildName, List<ConfigEntry> configuration, string queryType, string binaryPath, string commandLine, long cores, long speed, long memory, long version, DateTime updatedAt, DateTime createdAt, System.Guid fleetID = default, string fleetName = default)
        {
            Id = id;
            Name = name;
            FleetID = fleetID;
