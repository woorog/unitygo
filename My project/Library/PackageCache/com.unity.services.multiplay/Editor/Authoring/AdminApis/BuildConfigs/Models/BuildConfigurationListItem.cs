...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    internal class BuildConfigurationListItem
    {
        ...
        [Preserve]
        public BuildConfigurationListItem(long id, string name, long buildID, string buildName, long version, DateTime? updatedAt, DateTime? createdAt, System.Guid fleetID = default, string fleetName = default)
        {
            Id = id;
            Name = name;
            BuildID = buildID;
