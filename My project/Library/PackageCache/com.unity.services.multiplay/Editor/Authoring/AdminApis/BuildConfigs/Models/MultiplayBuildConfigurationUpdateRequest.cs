...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    internal class MultiplayBuildConfigurationUpdateRequest
    {
        ...
        [Preserve]
        public MultiplayBuildConfigurationUpdateRequest(string name, long buildID, List<ConfigurationPair1> configuration, string queryType, string binaryPath, string commandLine, long cores, long speed, long memory)
        {
            Name = name;
            BuildID = buildID;
