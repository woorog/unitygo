...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    internal class BuildConfigurationCreateRequest
    {
        ...
        [Preserve]
        public BuildConfigurationCreateRequest(string name, long buildID, string queryType, string binaryPath, string commandLine, long cores, long speed, long memory, List<ConfigurationPair> configuration = default)
        {
            Name = name;
            BuildID = buildID;
